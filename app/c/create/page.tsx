...
function CreateCommunityPage() {
  ...
  return (
    ...
    <p className='text-muted-foreground text-center text-balance'>Ready to rally your own crew of helpers? Dive in and craft your community! Connect, share, and grow together in a space that's all yours. Whether it's lending a hand or swapping skills, let's make it happen. Start building your crew now! <br /> <br />
