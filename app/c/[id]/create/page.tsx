...
import {
  TipTapEditor
} from '@/app/_components/TipTapEditor';
import {
  SubmitButton
} from '@/app/_components/SubmitButtons';
import {
  UploadDropzone
} from '@/app/_components/Uploadthing';
import {
  createRequest
} from '@/app/actions';
import {
...
export default function CreateRequest({
  ...
  const createRequestFitrii = createRequest.bind(null, {
    jsonContent: json
  })
  const intervals = [{
    label: '1 Day',
